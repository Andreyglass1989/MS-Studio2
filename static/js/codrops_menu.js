$(function() {
	...
	$('#bg1,#bg2,#bg3').mouseover(function(e){
		...
		if(item == 'bg1' || current == 2)
			$('#menu .sub'+parseInt(current+1))
			    .stop()
				.animate({backgroundPosition:"(-433px 0)"},350,function(){
					$(this).find('li').hide();
				});
		else
			$('#menu .sub'+parseInt(current+1))
		...
		if(current == 2 && item == 'bg1'){
			...
			.stop()
			.animate({backgroundPosition:"(-433px 0)"},350);
		}
		...
		$('#menu .sub'+parseInt(current+1))
			.stop().animate({backgroundPosition:"(0 0)"},350,function(){
				$(this).find('li').fadeIn();
			});
	});
	/*
	...
	function move(dir,item){
		if(dir){
			...
			$('#bg2').parent()
					 .stop()
					 .animate({backgroundPosition:"(-432px 0)"},350);
			$('#bg3').parent()
					 .stop()
					 .animate({backgroundPosition:"(-866px 0)"},400,function(){
			...
			$('#bg1').parent()
					 .stop()
					 .animate({backgroundPosition:"(0 0)"},500,function(){
						$('#menuWrapper').removeClass('bg1 bg2 bg3')
										 .addClass(item);
					 });
			$('#bg2').parent()
					 .stop()
					 .animate({backgroundPosition:"(-433px 0)"},450);
			$('#bg3').parent()
					 .stop()
					 .animate({backgroundPosition:"(-866px 0)"},350);
		}
	}
});